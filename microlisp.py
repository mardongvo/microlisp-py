...
STANDART_LOGIC_FUNC = {
"not": {"params_count": 1, "func": (lambda a: not a)},
"and": {"params_count": 2, "func": (lambda a, b: a and b)},
"or": {"params_count": 2, "func": (lambda a, b: a or b)},
"if": {"params_count": 3, "func": (lambda a, b, c: b if a else c)},
}    
    
def microlisp_eval(expr, funcs, env):
    if isinstance(expr, tuple) or isinstance(expr, list):
        ...
        return func_def["func"]( *map(lambda a: microlisp_eval(a, funcs, env), expr[1:]) )
